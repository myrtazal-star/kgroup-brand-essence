...
const propertiesData = {
  ...
  "r5": {
    ...
    featured: false,
    description: "Acogedor departamento en renta ubicado en Arquímedes, Polanco. Completamente amueblado con acabados modernos y en una ubicación privilegiada cerca de restaurantes y centros comerciales.",
